...
public class PickUpObject : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (!hasItem && Input.GetKeyDown(KeyCode.E))  // if you have an item and get the key to remove the object, again can be any key
            {
            ...
            else if(hasItem && Input.GetKeyDown(KeyCode.E))
            {
